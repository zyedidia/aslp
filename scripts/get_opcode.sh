...
# taken from https://github.com/UQ-PAC/barrier-tools/blob/main/get_opcode.sh
# with modifications to output for ASLi.
...
cat $TMP_DIR/tmp.asm | grep '0:' | grep -oP '[0-9a-f]{8}' | xargs printf '0x%s\n'